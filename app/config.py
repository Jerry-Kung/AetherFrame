...
# 种子提示词数量上限（§9 决策 #1）
MATERIAL_SEED_PROMPT_PER_DIRECTION_LIMIT = _int_env(
    "MATERIAL_SEED_PROMPT_PER_DIRECTION_LIMIT", 20
)
MATERIAL_SEED_PROMPT_PER_CHARACTER_LIMIT = _int_env(
    "MATERIAL_SEED_PROMPT_PER_CHARACTER_LIMIT", 100
)

# 首页批量创作并行执行 worker 池容量
CREATION_BATCH_PARALLEL_WORKERS = _int_env("CREATION_BATCH_PARALLEL_WORKERS", 4)
